export const labels = {
  ...
  line: {
    ...
    depthRangeM: 'Дълбочина на проучване',
    ...
    confirmDelete: 'Сигурен ли си? Това ще изтрие профила.',
  },
  capture: {
  ...
  anomaly: {
    ...
    fields: {
      fromPoint: 'От точка',
      toPoint: 'До точка',
      fromDepth: 'От дълбочина (m)',
      toDepth: 'До дълбочина (m)',
      type: 'Вид',
      confidence: 'Увереност (1–5)',
      note: 'Бележка',
    },
    calibrate: 'Калибрирай изображението',
    calibrateStep1: 'Тапни горен ляв ъгъл на данните (точка 1, 0 m)',
    calibrateStep2: 'Тапни долен десен ъгъл (последна точка, макс. дълбочина)',
    calibrateDone: 'Калибровката е запазена',
    calibrateReset: 'Прекалибрирай',
    typeOptions: {
